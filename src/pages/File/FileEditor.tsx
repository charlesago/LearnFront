...
import { Save, Move, ArrowLeft, Edit3, FolderOpen, Loader2, Brain } from "lucide-react";
...
const FileEditor: React.FC = () => {
    ...
    const handleMoveFile = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                // Redirection vers le nouveau dossier après 1.5 secondes
                setTimeout(() => {
                    navigate(`/folder/${currentFolder}`);
                }, 1500);
            } else {
    ...
    const handleCreateQuiz = async () => {
        ...
        try {
            ...
            if (response.ok) {
                // Rediriger vers le quiz créé
                navigate(`/quiz/${data.quiz.id}`);
            } else {
                if (data.quiz_id) {
                    // Quiz existe déjà, rediriger vers le quiz existant
                ...
                <div className="p-6 lg:p-8">
                    ...
                    <div className="mb-8">
                        <div className="flex items-center space-x-4 mb-4">
                            ...
                            <div>
                                <h1 className="text-3xl font-bold text-gray-900">Éditeur de fichier</h1>
                                <p className="text-gray-600">Modifiez votre fichier et organisez-le</p>
                            </div>
                        </div>
                    </div>
